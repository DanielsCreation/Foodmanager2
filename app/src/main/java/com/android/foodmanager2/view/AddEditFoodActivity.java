...
//intent components
    public static final String EXTRA_FOODID =
            "com.android.foodmanager2.food.EXTRA_FOODID";
    ...
    public static final String EXTRA_PRICE =
            "com.android.foodmanager2.food.EXTRA_PRICE";
    ...
    private EditText name_input, brand_input, store_input, price_input, contents_input, kcal_input, protein_input, carb_input, fat_input, sugar_input, saturated_input;
...
//-----------------------------------------------------------------------------------------------------
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent.hasExtra(EXTRA_FOODID)){
            setTitle("Bearbeiten");

            name_input.setText(intent.getStringExtra(EXTRA_NAME));
            brand_input.setText(intent.getStringExtra(EXTRA_BRAND));
            store_input.setText(intent.getStringExtra(EXTRA_STORE));
            price_input.setText(intent.getStringExtra(EXTRA_PRICE));
...
//-----------------------------------------------------------------------------------------------------
    ...
    private void saveFood() {
        ...
        data.putExtra(EXTRA_STORE, store);
        ...
        int foodId = getIntent().getIntExtra(EXTRA_FOODID, -1);
        if (foodId != -1) {
            data.putExtra(EXTRA_FOODID, foodId);
        }
...
//-----------------------------------------------------------------------------------------------------
    ...
    @Override
    public void onItemSelected(AdapterView<?> parent, View view, int position, long foodId) {
    }
